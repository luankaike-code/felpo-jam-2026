...
static var relation_name_type: Dictionary[names, types] = {
	...
	names.dead_screen_music: types.music,
	...
	names.error: types.sound_effect,
...
static var streams: Dictionary[names, AudioStreamMP3] = {
	...
	names.dead_screen_music: preload("res://assets/music/dead_screen_music.mp3"),
	...
	names.error: preload("res://assets/sounds_effects/error.mp3"),
