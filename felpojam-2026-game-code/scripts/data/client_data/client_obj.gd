...
var time_to_do: float

func _init(character_name_: CharacterData.names, order_speech_: SpeechsData.names,  get_order_speech_: SpeechsData.names, order_: OrdersData.names, time_to_do_: float) -> void:
	character_name = character_name_
	order = order_
	order_speech = order_speech_
	get_order_speech = get_order_speech_
	time_to_do = time_to_do_
